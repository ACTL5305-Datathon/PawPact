...
```{r}
medianincome <-read.csv('/Users/visweshnarayan/Downloads/MedianInc.csv')


# Perform a left join (UNSW earned data left join with external data based on postcode)
earned_data <- merge(earned_data, medianincome, by = "nb_postcode", all.x = TRUE)
...
write_csv(tweedie_df, "../data/transformed/tweedie.csv")
```
